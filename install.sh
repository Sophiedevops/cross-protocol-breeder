#!/bin/sh
# =================================================================================
# Cross-Protocol Breeder - Smart Installer v3.3 (Padavan BusyBox-friendly)
# =================================================================================
# КЛЮЧЕВЫЕ ИЗМЕНЕНИЯ:
    ...
    case "$arch_raw" in
        ...
        mips)
            if [ "$endian" = "le" ]; then
                ...
                warn "Не удалось определить endianness автоматически"
                warn "По умолчанию использую BE (mips)"
                warn "Если у вас MT7620/MT7621 — установите:"
                warn "  FORCE_ENDIAN=le $0"
                base="mips"
            fi
            ;;
...
# ============================================================================
log "${CYAN}================================================================${RESET}"
log "${CYAN}  Cross-Protocol Breeder — Smart Installer v3.3                ${RESET}"
log "${CYAN}================================================================${RESET}"
